...
class TestTranscriptWriter:
    ...
    def test_add_entry(self, temp_dir):
        ...
        writer.add_entry(0.0, "Alex", "Hello")
        writer.add_entry(5.0, "Jordan", "Hi there")

        assert len(writer.entries) == 2
        assert "Alex" in writer.participants
        assert "Jordan" in writer.participants
    ...
    def test_add_entry_ignores_empty(self, temp_dir):
        ...
        writer.add_entry(0.0, "Alex", "")
        writer.add_entry(5.0, "Alex", "   ")
        writer.add_entry(10.0, "Alex", None)
    ...
    def test_get_duration(self, temp_dir):
        ...
        writer.add_entry(0.0, "Alex", "Hello")
        writer.add_entry(30.0, "Jordan", "Goodbye")
    ...
    def test_generate_markdown(self, temp_dir):
        ...
        writer.add_entry(0.0, "Alex", "Hello everyone")
        writer.add_entry(5.0, "Jordan", "Hi Alex")
    ...
    def test_entries_sorted_by_timestamp(self, temp_dir):
        ...
        writer.add_entry(10.0, "Jordan", "Second")
        writer.add_entry(0.0, "Alex", "First")
        writer.add_entry(20.0, "Alex", "Third")
