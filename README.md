...
│   ├── Alex.npy                  # Example enrolled speaker
│   └── Jordan.npy                  # Example enrolled speaker
│
...
git clone https://github.com/wadyatalkinabewt/koe.git C:\Projects\koe
...
1. **Clone or download the repository**
   ```powershell
   git clone https://github.com/wadyatalkinabewt/koe.git C:\Projects\koe
   # Or download and extract ZIP to C:\Projects\koe
   ```
