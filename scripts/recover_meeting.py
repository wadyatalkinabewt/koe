...
def main():
    ...
    initial_prompt = "Alex, Jordan, Sash, Sritam, Thomas, Push, Bevis, Maxim, Jacky. Use proper punctuation including periods, commas, and question marks."
    ...
    # 8. Save transcript
    output_dir = Path("C:/Users/Example/Documents/Meetings")
