...
def find_ffmpeg():
    ...
    if IS_WINDOWS:
        ...
        # Hardcoded fallback
        winget_path = r"C:\Users\Example\AppData\Local\Microsoft\WinGet\Packages\Gyan.FFmpeg_Microsoft.Winget.Source_8wekyb3d8bbwe\ffmpeg-8.0.1-full_build\bin\ffmpeg.exe"
